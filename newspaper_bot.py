...
# Heavy / optional imports are deferred where possible so `python newsbot.py
# decrypt` works on a machine that doesn't have praw / google-genai installed
# and doesn't have Reddit env vars set.
